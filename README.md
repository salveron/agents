...
- **Rosters** ([rosters/](rosters/)) pick which roles are active, loaded on demand based on the prompt
  and the task in question. A short rosters reference is available in [AGENTS.md](AGENTS.md).
